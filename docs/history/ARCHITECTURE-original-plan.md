> Historical design plan, archived 2026-09-22. This describes an earlier migration target, not the current implementation. See [current architecture](../ARCHITECTURE.md).
